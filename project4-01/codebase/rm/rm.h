...
public:
  ...
  RC createIndex(const string &tableName, const string &attributeName) {return RM_EOF;};

  RC destroyIndex(const string &tableName, const string &attributeName) {return RM_EOF;};
  ...
  RC indexScan(const string &tableName,
                        ...
                        RM_IndexScanIterator &rm_IndexScanIterator) {return RM_EOF;};
